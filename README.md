...
| --- | --- | --- |
| 2026-07-24 | `v0.7.24-alpha.1053` | 代码理解补齐 6 项能力(查找实现、跳转类型定义、同名符号高亮、代码补全、签名提示、格式化)并按语言服务器实际支持优雅降级;修复 Vue / Astro 语言服务器开箱即坏。 |
| 2026-07-23 | `v0.7.23-alpha.1853` | 顶部标签条支持固定与拖拽重排、侧栏会话列表可自定义排序与分组;系统修复并行子任务卡住及自动压缩后上下文未收敛。 |
