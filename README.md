...
| --- | --- | --- |
| 2026-07-01 | `v0.7.1-alpha.1608` | 稳定性与界面细节修复:未配置模型时发送不再卡住,子进程异常退出给出真实诊断,全窗遮罩补齐圆角。 |
| 2026-06-30 | `v0.6.30-alpha.1728` | 新增麒麟操作系统(x86)支持,内部标识由 zcode 迁移为 avlcode,意图复述新增「保留我的本意」与选择统计,并行子任务实时状态展示。 |
| 2026-06-29 | `v0.6.29-alpha.1758` | 建索引 / LSP 进度提示优化:由满屏 toast 改为单条原地更新的进度条。 |
| 2026-06-29 | `v0.6.29-alpha.1624` | 新增全库代码检索与问答(`code.search` / `code.ask`,纯本地可离线),代码引用可点跳转,「复述意图」继续打磨。 |
| 2026-06-29 | `v0.6.29-alpha.1123` | 「复述意图」触发更精准:仅当开场首条消息较短或较简单时才先对齐目标。 |
| 2026-06-29 | `v0.6.29-alpha.0921` | 「复述意图」不再打扰已写清楚的长消息:长而详细的开场直接开工、不弹确认。 |
