...
| 2026-07-01 | `v0.7.1-alpha.2046` | 插件市场与已装插件支持检查更新与升级,下载 / 更新显示真实行内进度;修复脱敏遗漏行首 IP、麒麟 V11(Wayland)多余标题栏。 |
| 2026-07-01 | `v0.7.1-alpha.1608` | 稳定性与界面细节修复:未配置模型时发送不再卡住,子进程异常退出给出真实诊断,全窗遮罩补齐圆角。 |
| 2026-06-30 | `v0.6.30-alpha.1728` | 新增麒麟操作系统(Kylin Desktop V10 SP1,x86)编译与运行支持,便于国产化环境部署。 |
| 2026-06-30 | `v0.6.30-alpha.1258` | 内部标识由 zcode 迁移为 avlcode(配置目录 / 环境变量 / 字段),意图复述新增「保留我的本意」与选择统计。 |
